...
public class EstocLugar {
    ...
    public EstocLugar(int estoc_id, int estoc_quantitat, int estoc_maxim, int estoc_minim, int producte_id, int lloc_id, String lloc_bloc, String lloc_passadis, String lloc_lleixa) {
