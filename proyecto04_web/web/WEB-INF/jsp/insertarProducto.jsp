<%-- 
    ...
    Created on : 06-mar-2019, 4:30:21
    Author     : Usuario
--%>
...
<div class="container">
    ...
    <form:form class="form-horizontal form-con-fondo" modelAttribute="producto" action="insertarProducto" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <form:input type="number" path="producte_descompte" class="form-control"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <form:input type="number" path="estoc_quantitat" class="form-control"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <form:input type="number" path="estoc_minim" class="form-control"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <form:input type="number" path="estoc_maxim" class="form-control"/>
