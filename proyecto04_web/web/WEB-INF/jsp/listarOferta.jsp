<%-- 
    Document   : listarOferta
    Created on : 06-mar-2019, 10:39:08
    Author     : Usuario
--%>
...
<div class="container" id="cont">
    ...
    <div class="container div-contenedor-buscador">
        <!--        <div class="row">-->
        <form:form class="form-horizontal col-sm-12" modelAttribute="producto" action="filtrarOferta" method="POST">
